...
<body class="index-page">
        ...
        <div class="row">
          <div class="col-lg-7 mx-auto md-9">
            <div class="card shadow-sm">
              <div class="card-body">
                <?php flash('msg'); ?>
                <h1 class="h4 mb-3">Upload Audio Messages</h1>
                <form method="POST" id="uploadForm" action="<?php echo URLROOT; ?>/audio/add" enctype="multipart/form-data" novalidate>
                  <!-- Audio meta -->
                  <div class="mb-3">
                    <label class="form-label">Title <span class="text-danger">*</span></label>
                    <input required name="title" class="form-control" type="text" placeholder="Message Title">
                  </div>

                  <div class="mb-3">
                    <label class="form-label">Preacher <span class="text-danger">*</span></label>
                    <input required name="preacher" class="form-control" type="text" placeholder="Name of Preacher">
                  </div>
                  <!-- <div class="mb-3">
                    <label class="form-label">Details <span style="font-size: smaller;">(Optional)</span></label>
                    <input name="details" class="form-control" type="text" placeholder="Holy seminar, 2021. organized by ---">
                  </div> -->
                  <div class="row g-3 mb-3">
                    ...
                    <div class="col-md-6">
                      ...
                      <input required type="text" name="month_year" class="form-control" placeholder="eg 05,2024">
                  ...
                  <div class="row g-3 mb-3">
                    ...
                    <div class="col-md-6">
                      <label class="form-label">Audio file (required)</label>
                      <input required name="audio_file" id="fileInput" class="form-control" type="file" accept="audio/*">
                      <div style="font-size: small;" class="form-text">Not more than 50mb.</div>
  ...
  <script>
    const MAX_FILE_SIZE = 50 * 1024 * 1024; // 2MB in bytes
